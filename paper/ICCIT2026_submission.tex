...
(Figs.~\ref{fig:spectrum}--\ref{fig:thdtime}). Three representative
...
\begin{figure}[H]
\centerline{\includegraphics[width=\linewidth]{figs/fig8_thd_timeseries.png}}
\caption{THD$_i$/THD$_v$ vs.\ time: the same suppression event as
Fig.~\ref{fig:spectrum}, shown in the time domain, with the
voltage-sag window and IEEE 519 limit marked.}
\label{fig:thdtime}
\end{figure}
...
Fig.~\ref{fig:distcm}). SHAP analysis (Fig.~\ref{fig:shap}) shows
\texttt{voltage\_rms\_V}
...
\begin{figure}[H]
\centerline{\includegraphics[width=\linewidth]{figs/fig9_disturbance_confusion.png}}
\caption{Disturbance classifier confusion matrix on held-out real
Jamalpur data (test accuracy 0.997).}
\label{fig:distcm}
\end{figure}
...
\begin{figure}[H]
\centerline{\includegraphics[width=\linewidth]{figs/fig7_dashboard.png}}
...
\begin{figure}[H]
\centerline{\includegraphics[width=\linewidth]{figs/fig4_bridge_confusion.png}}
...
\begin{figure*}[t!]
\centerline{\includegraphics[width=0.85\textwidth]{figs/fig5_cost_sensitivity.png}}
